...
map = basemap %>% addPolygons(data=dat_merged_cbgs_historical, 
                      stroke = TRUE, weight=1, smoothFactor = 0.1, fillOpacity = 0.8, 
...
The plot below shows contact trends in `r town` over time in <font color=\"#00AA00\"><b>contact rates</b></font>, with trends for individual census block groups shown in black. Gray bars represent weekends. 
